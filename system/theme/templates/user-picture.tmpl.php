...
<div class="e2-user-picture-container e2-external-drop-target" data-href="<?= $content['blog']['userpic-upload-action'] ?>">
  ...
  <?php } ?>
  <span class="e2-user-picture-uploading"><?= _SVG ('spin-progress') ?></span>
</div>
